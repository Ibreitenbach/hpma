...
function getDomainLabel(domain: Question['domain']): string {
  const labels: Record<Question['domain'], string> = {
    H: 'Honesty-Humility',
    E: 'Emotionality',
    X: 'Extraversion',
    A: 'Agreeableness',
...
function getDomainColor(domain: Question['domain']): string {
  const colors: Record<Question['domain'], string> = {
